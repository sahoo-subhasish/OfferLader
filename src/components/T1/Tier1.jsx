...
import { Tier1Problems } from '../../Data/Tier-1';
...
export default function ProblemExplorer() {
  ...
  const [problems, setProblems] = useState(Tier1Problems);
    ...
    <div className="flex flex-col gap-6 md:gap-8 animate-in fade-in duration-500 max-w-[1200px] mx-auto p-4 md:p-6 mb-20">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
        <div className="max-w-xl">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 tracking-tighter">{cardInfo[5].subtitle}</h1>
          <p className="text-[#888] text-sm leading-relaxed font-medium">{cardInfo[5].desc}</p>
        </div>
